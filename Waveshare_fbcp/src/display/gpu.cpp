...
void InitGPU()
{
  ...
  */
  ...
  // printf("DISPLAY_DRAWABLE_HEIGHT = %f  \r\n",scalingFactorHeight);
  ...
  // printf("DISPLAY_BREAK_ASPECT_RATIO_WHEN_SCALING\r\n");
  ...
  printf("scalingFactorWidth = %f  scalingFactorHeight = %f \r\n",scalingFactorWidth,scalingFactorHeight);
